...
class CppModel : public QObject {
  Q_OBJECT
  Q_PROPERTY(QString thumbnailSrc READ thumbnailSrc WRITE setThumbnailSrc NOTIFY
                 thumbnailSrcChanged)
...
public:
  ...
  QString thumbnailSrc() const { return this->m_thumbnailSrc; }
  QStringList labels() const { return this->m_labels; }
signals:
